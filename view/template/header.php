...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
  <div class="wrapper">
    ...
    <!-- <div class="preloader flex-column justify-content-center align-items-center">
      <img class="animation__wobble" src="./public/img/logo.png" alt="AdminLTELogo" height="80" width="80">
    </div> -->
    <!-- Navbar -->
    <nav class="main-header navbar navbar-expand navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="#" class="nav-link">Registro de asistencias</a>
        </li>
      </ul>
      <!-- Right navbar links -->
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img src="./public/img/logo.png" alt="Aafy Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
        <span class="brand-text font-weight-light">AAFY</span>
      </a>
      <!-- Sidebar -->
      <div class="sidebar">
